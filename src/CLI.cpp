...
void printUsage(const char* progName, std::ostream* outputStream) {
    ...
    out << "  --positioning <mode>      Positioning: online, precompute (default: online)\n";
    out << "  --split-selection <mode>  Split selection: all, sampling (default: all)\n";
    out << "  --split-scoring <mode>    Split scoring: variance, entropy, minmax, balance, none, random (default: variance)\n";
