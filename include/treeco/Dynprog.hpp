...
inline std::string explorationTypeToString(Exploration type) {
    switch (type) {
        case Exploration::GREEDY: return "greedy";
        case Exploration::ITERATIVE: return "iterative";
        case Exploration::EXHAUSTIVE: return "exhaustive";
...
inline Exploration stringToExplorationType(const std::string& str) {
    ...
    throw std::invalid_argument(
        "Invalid exploration type: " + str + ". Available options are: "
...
inline std::string branchingTypeToString(Branching type) {
    switch (type) {
        case Branching::BINARY: return "binary";
        case Branching::TERNARY: return "ternary";
        default: return "unknown";
    }
}
...
inline Branching stringToBranchingType(const std::string& str) {
    ...
    throw std::invalid_argument(
        "Invalid branching type: " + str + ". Available options are: "
        "binary, ternary."
    );
}
...
inline std::string lowerBoundingTypeToString(LowerBounding type) {
    switch (type) {
        case LowerBounding::FIXED: return "fixed";
        case LowerBounding::BACKTRACK: return "backtrack";
        default: return "unknown";
    }
}
...
inline LowerBounding stringToLowerBoundingType(const std::string& str) {
    ...
    throw std::invalid_argument(
        "Invalid lower bounding type: " + str + ". Available options are: "
        "fixed, backtrack."
    );
}
...
inline std::string positioningTypeToString(Positioning type) {
    switch (type) {
        case Positioning::ONLINE: return "online";
        case Positioning::PRECOMPUTE: return "precompute";
        default: return "unknown";
    }
}
...
inline Positioning stringToPositioningType(const std::string& str) {
    ...
    throw std::invalid_argument(
        "Invalid positioning type: " + str + ". Available options are: "
        "online, precompute."
    );
}
...
inline std::string splitSelectionTypeToString(SplitSelection type) {
    switch (type) {
        case SplitSelection::ALL: return "all";
        case SplitSelection::SAMPLING: return "sampling";
        default: return "unknown";
    }
}
...
inline SplitSelection stringToSplitSelectionType(const std::string& str) {
    ...
    throw std::invalid_argument(
        "Invalid split selection type: " + str + ". Available options are: "
        "all, sampling."
    );
}
...
inline std::string splitScoringTypeToString(SplitScoring type) {
    switch (type) {
        case SplitScoring::VARIANCE: return "variance";
        case SplitScoring::ENTROPY: return "entropy";
        case SplitScoring::MINMAX: return "minmax";
        case SplitScoring::NONE: return "none";
        case SplitScoring::RANDOM: return "random";
        default: return "unknown";
    }
}
...
inline SplitScoring stringToSplitScoringType(const std::string& str) {
    ...
    throw std::invalid_argument(
        "Invalid split scoring type: " + str + ". Available options are: "
...
inline std::string dynprogStatusToString(DynprogStatus status) {
    switch (status) {
        case DynprogStatus::INVALID: return "invalid";
        case DynprogStatus::SUBOPTIMAL: return "suboptimal";
        case DynprogStatus::OPTIMAL: return "optimal";
        default: return "unknown";
    }
}
