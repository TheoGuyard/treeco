...
public:
     ...
     * @param fileDomain Path to file containing cost domain constraints (optional)
     */
    LDTree(
...
private:
    ...
    void generateNormalCode(std::ostringstream& out, int dim, const std::string& doc) const;
    void generateBenchmarkCode(std::ostringstream& out, int dim, const std::string& doc) const;
