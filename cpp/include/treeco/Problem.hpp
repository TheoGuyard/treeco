...
public:
   ...
   */
  virtual Domain getCostDomain() const { return Domain(); }

  /**
   * @brief Sample a random cost vector.
   * @return Cost vector sampled with a random seed.
   */
   ...
   * @return Cost vector generated.
   * @note When not overloaded, the cost vector entries are sampled uniformly
   * in [0, 1).
   */
