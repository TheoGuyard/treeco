...
void LDTree::build(bool verbose, std::ostream* outputStream, double logInterval, bool logSave, double timeLimit,
                   double tolerance, bool deduplicate, bool useSlacks, bool strongChecks, bool filterChecks,
                   Exploration exploration, Branching branching, SplitScoring splitScoring) {
  ...
  DynprogParams dynprogParams =
      DynprogParams{verbose,   outputStream, logInterval,  logSave,      timeLimit - elapsedTime(startTime),
                    tolerance, useSlacks,    strongChecks, filterChecks, exploration,
                    branching, splitScoring};
